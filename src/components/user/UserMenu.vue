    ...
    <div class="col-lg-3 mb-4">
      <ul class="list-group">
        ...
        <li class="list-group-item user-menu" @click="menuClicked('personal-info')">
          <i class="fa-solid fa-user pe-2"></i>Profile Details
        </li>
        <li class="list-group-item user-menu">
          <i class="fas fa-heart pe-2"></i>Change Password
        </li>
        <li class="list-group-item user-menu">
          <i class="fa-solid fa-burger pe-2"></i>Transaction History
        </li>
        <li class="list-group-item user-menu">
          <i class="fa-solid fa-burger pe-2"></i>My Products
        </li>
      </ul>
    </div>
  </template>
