    ...
    <div class="container" style="margin-top: 130px;">
        <div class="row">
          <div class="d-flex justify-content-between">
            <div class="col-12">
              <h2 class="mb-0 fs-4 text-black">Other Product</h2>
            </div>
        </div>
          ...
          <div class="popular__list row d-flex">
                <div class="col-12 col-sm-2" style="padding-top: 12px; padding-bottom: 12px;" v-for="(product, index) in products" :key="index">
                    <div class="card mb-5" style="height: 300px;">
                        ...
                        <div class="mt-5">
                          <p class="text-black justify-content-between"> {{ product.size }} / {{ product.color }} <span><i class="fa-regular fa-heart ms-1"></i></span> 12</p>
                        </div>
                        </div>
                    </router-link>
                    </div>
